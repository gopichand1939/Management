          ...
          <div className="flex-1 w-full pt-12 lg:pt-16 pb-16 px-6 md:px-8">
            ...
            <div className="max-w-[440px] mx-auto w-full flex flex-col gap-6 md:gap-8">
              <div className="text-left">
                <h1 className="text-2xl font-black text-slate-800 tracking-tight">User Details</h1>
                <p className="text-sm text-slate-500 mt-1">View profile info and active status</p>
              </div>
              <ViewUser />
            </div>
          </div>
